...
run_stage_c_one <- function(sim_name, dat, coords, X_raw, y, b_true,
  ...
  # --- Plots ---
  png(sprintf("bayes_out/stage_c_%s.png", sim_name), width=1200, height=900)
  ...
  png(sprintf("bayes_out/stage_c_%s_trace.png", sim_name), width=1000, height=700)
...
cat("\nAll plots saved to bayes_out/stage_c_sim*.png\n")
