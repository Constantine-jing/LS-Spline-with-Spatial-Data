...
pdf("bayes_test/sim2_n1000_overlay_marginals.pdf", width = 10, height = 6)
...
dev.off()
cat("  Plot: bayes_test/sim2_n1000_overlay_marginals.pdf\n")

pdf("bayes_test/sim2_n1000_bayes_trace.pdf", width = 10, height = 10)
plot_gibbs_trace_full(gs, true_sigma2 = sigma2_true,
                          true_tau2   = tau2_true,
                          true_rho    = rho_true)
dev.off()
cat("  Plot: bayes_test/sim2_n1000_bayes_trace.pdf\n")
...
write.csv(comp_table, "bayes_test/sim2_n1000_reml_vs_bayes.csv", row.names = FALSE)
write.csv(cov_tab,   "bayes_test/sim2_n1000_bayes_coverage.csv",  row.names = FALSE)

cat("\nOutputs in bayes_test/:\n")
cat("  sim2_n1000_overlay_marginals.pdf\n")
