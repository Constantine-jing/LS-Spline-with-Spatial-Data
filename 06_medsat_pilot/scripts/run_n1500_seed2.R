## ============================================================
## scripts/run_n1500_seed2.R
##
## JOB 2 of the four-job Hellbender batch — multi-seed robustness
...
## stratified subsample (seed=2).
##
## Settings are identical to run_n1500_seed3.R / run_n1500_seed4.R
## except for the sim file. See run_n1500_headline_seed1.R for the
## polished single-seed companion.
##
## Output: output/fit_medsat_n1500_seed2_allpairs_hb.rds
##
## Usage on Hellbender (submitted by .sub):
##   Rscript scripts/run_n1500_seed2.R
##
## Local dry-run (tiny, discards output):
##   MEDSAT_DRY_RUN=1 Rscript scripts/run_n1500_seed2.R
## ============================================================
